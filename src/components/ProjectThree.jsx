  ...
  return (
    <div id="projetos" className="bg-white shadow-lg rounded-xl pb-2 ">
      ...
      <p className="mt-4 text-gray-500 px-5">
        ...
        memoráveis com o cliquei.tech! Nosso serviço oferece um redirecionamento
        simples e eficiente, proporcionando uma experiência mais agradável para
        seus usuários. Simplifique a forma como você compartilha seus links e
        impulsione sua presença online com o cliquei.tech!{" "}
      </p>
