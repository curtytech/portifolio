...
const navigation = [
  ...
  { name: 'Sobre mim', href: '#sobremim', current: false },
  { name: 'Habilidades', href: '#habilidades', current: false },
  { name: 'Projetos', href: '#projetos', current: false },
  { name: 'Formação', href: '#formacao', current: false },
  { name: 'Experiência', href: '#experiencia', current: false },
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-primary')}
                          >
                            Your Profile
                          </a>
                        )}
